...
export class DebrisService extends PropsBaseService {
  debrisTextures: Texture[] = [
    this.textureService.getTexture('debris1') as Texture,
    this.textureService.getTexture('debris2') as Texture,
    this.textureService.getTexture('debris3') as Texture,
    this.textureService.getTexture('debris4') as Texture,
    this.textureService.getTexture('debris5') as Texture
  ];

  override type: ElementType = ElementType.DEBRIS;

  override texture: Texture = this.textureService.getTexture('debris1') as Texture;
