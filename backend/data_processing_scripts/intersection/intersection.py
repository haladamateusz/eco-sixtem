...
intraday_snapshots_dataframe = pd.read_csv(f'''../intraday_snapshots/lookup_status_intraday_snapshots_found_only_{filename}.csv''')
end_of_day_history_dataframe = pd.read_csv(f'''../end_of_day_history/lookup_status_end_of_day_history_found_only_{filename}.csv''')
