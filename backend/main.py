...
if __name__ == '__main__':
    findata = FinancialDataAPI('/Users/mateuszhalada/Hackaton_St_Gallen/sixxy')

    sample1 = findata.instrumentBase("ISIN", ["BE6342120662"])

    sample2 = findata.endOfDayHistory("ISIN",['US0378331005'], '2022-01-01', '2022-01-0')
    print(json.dumps(sample2, sort_keys=True, indent=4))